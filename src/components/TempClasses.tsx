...
<HStack spacing={5}>
          <Link href="https://lostark.nexus/Slayer">
            <VStack>
              ...
              <Text fontSize="18px" fontWeight={"500"} textAlign="center">Slayer</Text>
            </VStack>
          </Link>
          ...
          <Link href="https://lostark.nexus/Berserker">
            <VStack>
              ...
              <Text fontSize="18px" fontWeight={"500"} textAlign="center">Berserker</Text>
            </VStack>
          </Link>
          ...
          <Link href="https://lostark.nexus/Destroyer">
            <VStack>
              ...
              <Text fontSize="18px" fontWeight={"500"} textAlign="center">Destroyer</Text>
            </VStack>
          </Link>
          ...
          <Link href="https://lostark.nexus/Gunlancer">
            <VStack >
              ...
              <Text fontSize="18px" fontWeight={"500"} textAlign="center" >Gunlancer</Text>
            </VStack>
          </Link>
          ...
          <Link href="https://lostark.nexus/Paladin">
            <VStack>
              ...
              <Text fontSize="18px" fontWeight={"500"} textAlign="center">Paladin</Text>
            </VStack>
          </Link>
      </HStack>
      ...
      <HStack spacing={5}>
          <Link href="https://lostark.nexus/Sorceress">
            <VStack>
              ...
              <Text fontSize="18px" fontWeight={"500"} textAlign="center">Sorceress</Text>
            </VStack>
          </Link>
          ...
          <Link href="https://lostark.nexus/Arcana">
            <VStack>
              ...
              <Text fontSize="18px" fontWeight={"500"} textAlign="center">Arcana</Text>
            </VStack>
          </Link>
          ...
          <Link href="https://lostark.nexus/Summoner">
            <VStack>
              ...
              <Text fontSize="18px" fontWeight={"500"} textAlign="center">Summoner</Text>
            </VStack>
          </Link>
          ...
          <Link href="https://lostark.nexus/Bard">
            <VStack >
              ...
              <Text fontSize="18px" fontWeight={"500"} textAlign="center" >Bard</Text>
            </VStack>
          </Link>
      </HStack>
          ...
          <Link href="https://lostark.nexus/Striker">
            <VStack>
              ...
              <Text fontSize="18px" fontWeight={"500"} textAlign="center">Striker</Text>
            </VStack>
          </Link>
          ...
          <Link href="https://lostark.nexus/Wardancer">
            <VStack>
              ...
              <Text fontSize="18px" fontWeight={"500"} textAlign="center">Wardancer</Text>
            </VStack>
          </Link>
          ...
          <Link href="https://lostark.nexus/Scrapper">
            <VStack>
              ...
              <Text fontSize="18px" fontWeight={"500"} textAlign="center">Scrapper</Text>
            </VStack>
          </Link>
          ...
          <Link href="https://lostark.nexus/Soulfist">
            <VStack >
              ...
              <Text fontSize="18px" fontWeight={"500"} textAlign="center" >Soulfist</Text>
            </VStack>
          </Link>
          ...
          <Link href="https://lostark.nexus/Glaivier">
            <VStack>
              ...
              <Text fontSize="18px" fontWeight={"500"} textAlign="center">Glaivier</Text>
            </VStack>
          </Link>
      </HStack>
          ...
          <Link href="https://lostark.nexus/Gunslinger">
            <VStack>
              ...
              <Text fontSize="18px" fontWeight={"500"} textAlign="center">Gunslinger</Text>
            </VStack>
          </Link>
          ...
          <Link href="https://lostark.nexus/Deadeye">
            <VStack>
              ...
              <Text fontSize="18px" fontWeight={"500"} textAlign="center">Deadeye</Text>
            </VStack>
          </Link>
          ...
          <Link href="https://lostark.nexus/Artillerist">
            <VStack>
              ...
              <Text fontSize="18px" fontWeight={"500"} textAlign="center">Artillerist</Text>
            </VStack>
          </Link>
          ...
          <Link href="https://lostark.nexus/Machinist">
            <VStack >
              ...
              <Text fontSize="18px" fontWeight={"500"} textAlign="center" >Machinist</Text>
            </VStack>
          </Link>
          ...
          <Link href="https://lostark.nexus/Sharpshooter">
            <VStack>
              ...
              <Text fontSize="18px" fontWeight={"500"} textAlign="center">Sharpshooter</Text>
            </VStack>
          </Link>
      </HStack>
          ...
          <Link href="https://lostark.nexus/Shadowhunter">
            <VStack>
              ...
              <Text fontSize="18px" fontWeight={"500"} textAlign="center">Shadowhunter</Text>
            </VStack>
          </Link>
          ...
          <Link href="https://lostark.nexus/Deathblade">
            <VStack>
              ...
              <Text fontSize="18px" fontWeight={"500"} textAlign="center">Deathblade</Text>
            </VStack>
          </Link>
          ...
          <Link href="https://lostark.nexus/Reaper">
            <VStack>
              ...
              <Text fontSize="18px" fontWeight={"500"} textAlign="center">Reaper</Text>
            </VStack>
          </Link>
      </HStack>
          ...
          <Link href="https://lostark.nexus/Artist">
            <VStack>
              ...
              <Text fontSize="18px" fontWeight={"500"} textAlign="center">Artist</Text>
            </VStack>
          </Link>
          ...
          <Link href="https://lostark.nexus/Aeromancer">
            <VStack>
              ...
              <Text fontSize="18px" fontWeight={"500"} textAlign="center">Aeromancer</Text>
            </VStack>
          </Link>
      </HStack>
