      ...
      <div className="bg-070709 flex justify-center items-center">
        <div className="text-white flex flex-col items-center">
          ...
          <div className="flex justify-center items-center text-center max-w-2xl mb-4 mx-14">
            Lost Ark Nexus is a community made non-profit website and hub for a large array of community assets most notably the Community Guides. The purpose
            of this site is to help redirect users to various community resources that may or may not be created by the Lost Ark Nexus or Community Guide team.
          </div>
